...
/* ── Right Sidebar - AI 智能工作区（科幻风格）── */
.right-sidebar{{
  width:340px;
  background:linear-gradient(180deg, #0F1419 0%, #1A1F2E 100%);
  border-left:1px solid rgba(22,194,91,0.2);
  padding:24px 20px;
  overflow-y:auto;
  position:relative;
}}
.right-sidebar::before{{
  ...
  background:radial-gradient(circle at 50% 0%, rgba(22,194,91,0.08) 0%, transparent 60%);
  pointer-events:none;
}}
...
.ai-card::after{{
  ...
  height:1px;
  background:linear-gradient(90deg, transparent, rgba(22,194,91,0.6), transparent);
}}
...
.recommend-title{{
  ...
  color:#16C25B;
  margin-bottom:12px;
  text-shadow:0 0 8px rgba(22,194,91,0.4);
}}

.recommend-item{{
  background:rgba(255,255,255,0.03);
  border:1px solid rgba(22,194,91,0.15);
  border-radius:8px;
  padding:12px;
  margin-bottom:8px;
  cursor:pointer;
